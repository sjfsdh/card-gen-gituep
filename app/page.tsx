      ...
      <main className="flex-1">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="border-2 hover:border-purple-500 hover:shadow-lg transition-all">
              <CardHeader>
                <CardTitle>ID Card Generator</CardTitle>
                <CardDescription>
                  Create professional ID cards for employees, events, visitors, and more
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img
              ...
              <CardFooter>
                <Link href="/id-card-generator" className="w-full">
                  <Button className="w-full bg-purple-600 hover:bg-purple-700">Create ID Card</Button>
                </Link>
              </CardFooter>
            </Card>
            ...
            <Card className="border-2 hover:border-purple-500 hover:shadow-lg transition-all">
              ...
              <CardFooter>
                <Link href="/certificate-generator" className="w-full">
                  <Button className="w-full bg-purple-600 hover:bg-purple-700">Create Certificate</Button>
                </Link>
              </CardFooter>
            </Card>
          </div>
