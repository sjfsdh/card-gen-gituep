...
export default function VerifyPage() {
  ...
  const handleVerify = () => {
    ...
    setTimeout(() => {
      ...
      const idCardData = localStorage.getItem("idCardData")
      ...
      if (!foundData && idCardData) {
        const parsedIdCard = JSON.parse(idCardData)
        if (parsedIdCard.idCardId === verificationCode) {
          foundData = {
            type: "idCard",
            data: parsedIdCard,
          }
        ...
        <Card className="border-purple-200 bg-purple-50 dark:bg-purple-900/20 dark:border-purple-800">
          <CardHeader className="pb-2">
            <div className="flex items-center">
              <CheckCircle2 className="h-6 w-6 text-purple-600 dark:text-purple-400 mr-2" />
              <CardTitle className="text-purple-700 dark:text-purple-300">Verification Successful</CardTitle>
            </div>
            <CardDescription>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="capitalize">
                  {verificationData.type === "certificate"
                    ...
                    : verificationData.data.idCardType}
                </p>
              </div>
              ...
              {verificationData.type === "idCard" && verificationData.data.validUntil && (
                <div>
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-purple-800 dark:text-purple-400">
