    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-purple-800 dark:text-purple-400">Terms of Service</h1>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          By accessing or using the GitUEP website and services, you agree to be bound by these Terms of Service. If you
          do not agree to these terms, please do not use our services.
        </p>

        <h2>2. Description of Service</h2>
        <p>
          GitUEP provides an online platform for creating, customizing, and downloading ID cards and certificates. Our
          service allows users to generate professional documents without requiring registration or login.
        </p>
        ...
        <p>
          ...
          icons, images, audio clips, digital downloads, and software, are owned by GitUEP and are protected by
        ...
        <p>
          To the fullest extent permitted by applicable law, GitUEP shall not be liable for any indirect, incidental,
        ...
        <p>
          You agree to indemnify and hold harmless GitUEP and its officers, directors, employees, and agents from any
          claims, damages, liabilities, costs, or expenses arising from your use of our services or your violation of
        ...
        <p>
          Email: support@gituep.online
          <br />
          Phone: +1 (415) 789-2345
          <br />
          Address: 123 Credential Blvd, Suite 456, San Francisco, CA 94107
          <br />
