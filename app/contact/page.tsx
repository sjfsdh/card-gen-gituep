    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-purple-800 dark:text-purple-400">Contact Us</h1>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
        <div>
          <h2 className="text-2xl font-semibold mb-4 text-purple-700 dark:text-purple-500">Get in Touch</h2>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground">support@gituep.online</p>
              </div>
            </div>

            <div className="flex items-start">
              <Phone className="h-5 w-5 mr-3 text-purple-600 mt-0.5" />
              <div>
                <h3 className="font-medium">Phone</h3>
                <p className="text-muted-foreground">+1 (415) 789-2345</p>
              </div>
            </div>
