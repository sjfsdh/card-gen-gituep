    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-purple-800 dark:text-purple-400">Privacy Policy</h1>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          Welcome to GitUEP ("we," "our," or "us"). We respect your privacy and are committed to protecting your
