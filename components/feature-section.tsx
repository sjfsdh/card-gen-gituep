...
export function FeatureSection() {
  const features = [
    ...
    {
      icon: <FileImage className="h-10 w-10 text-purple-600" />,
    ...
    <div className="bg-purple-50/50 dark:bg-purple-950/20 py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-purple-800 dark:text-purple-400">Powerful Features</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Our platform offers everything you need to create professional credentials without any technical skills.
          </p>
        </div>
